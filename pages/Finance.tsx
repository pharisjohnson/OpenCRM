...
export const Finance: React.FC = () => {
    ...
    const handlePrint = (doc: FinanceDocument) => {
        ...
        router.push(`/finance/invoice/${doc.id}/print`);
        setActiveDownloadMenuId(null);
    };
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Finance & Invoicing</h1>
                    <p className="text-gray-500 dark:text-gray-400">Manage invoices, quotes, and payment tracking.</p>
                </div>
                <button
            ...
            <div className="flex flex-col gap-6">
                <div className="flex items-center gap-2 bg-gray-100 dark:bg-dark-bg p-1 rounded-lg w-fit">
                    <button
                        ...
                        className={`px-4 py-1.5 rounded-md text-sm font-medium transition-all ${activeTab === 'Invoice' ? 'bg-white dark:bg-dark-surface text-primary-600 dark:text-primary-400 shadow-sm' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200'}`}
                    >
                        Invoices
                    </button>
                    <button
                        onClick={() => setActiveTab('Quote')}
                        className={`px-4 py-1.5 rounded-md text-sm font-medium transition-all ${activeTab === 'Quote' ? 'bg-white dark:bg-dark-surface text-primary-600 dark:text-primary-400 shadow-sm' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200'}`}
                    >
                        Quotes
                    </button>
                </div>
                        ...
                        <div className="flex flex-1 min-w-[300px] gap-2">
                            <div className="relative flex-1">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-2 bg-white dark:bg-dark-surface border border-gray-200 dark:border-dark-border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/20 dark:text-white"
                                />
                            </div>
                            <button className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-dark-surface border border-gray-200 dark:border-dark-border rounded-xl text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-dark-bg transition-colors">
                                <Filter size={18} />
                                Filters
                            </button>
                        </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div className="bg-white dark:bg-dark-surface p-4 rounded-xl border border-gray-200 dark:border-dark-border shadow-sm">
                            ...
                            <h3 className="text-2xl font-bold text-gray-900 dark:text-white">
                                ${filteredDocs.reduce((sum, d) => sum + d.total, 0).toLocaleString()}
                            </h3>
                        </div>
                        <div className="bg-white dark:bg-dark-surface p-4 rounded-xl border border-gray-200 dark:border-dark-border shadow-sm">
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4">
                                                <span className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${doc.category === 'Service' ? 'bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400' : 'bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-400'}`}>
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        ...
                                        >
                                            <div className="w-full h-16 bg-white dark:bg-dark-bg border border-gray-300 dark:border-dark-border flex flex-col p-1 gap-1">
                                                <div className="h-1.5 w-full bg-gray-400 dark:bg-gray-600 rounded-sm"></div>
                                                <div className="h-px w-full bg-gray-200 dark:bg-dark-border"></div>
                                                <div className="flex-1 border border-gray-200 dark:border-dark-border"></div>
                                            </div>
                                        ...
                                        >
                                            <div className="w-full h-16 bg-white dark:bg-dark-bg flex flex-col p-1 gap-1.5">
                                                <div className="h-2 w-1/3 bg-gray-800 dark:bg-gray-400 rounded-sm"></div>
                                                <div className="h-1 w-full bg-gray-100 dark:bg-dark-border"></div>
                                                <div className="h-1 w-full bg-gray-100 dark:bg-dark-border"></div>
                                            </div>
