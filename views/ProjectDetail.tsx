            ...
            <div className="space-y-6 animate-in fade-in duration-300">
              ...
              <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {companies.map(c => (
                    <Link href={`/companies/${c.id}`} key={c.id} className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg hover:border-primary-300 hover:bg-primary-50 transition-all group">
